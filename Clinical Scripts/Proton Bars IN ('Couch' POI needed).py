...
seperation = 1.1 #half the distance from the bar to centre of couch
...
with CompositeAction('Create Box ROI (ROI Proton Bars IN)'):
...
with CompositeAction('ROI Algebra (Proton Bars IN)'):

  retval_0 = case.PatientModel.CreateRoi(Name=r"Proton Bars IN", Color="255, 128, 0", Type="Undefined", TissueName=None, RbeCellTypeName=None, RoiMaterial=None)
